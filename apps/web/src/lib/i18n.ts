...
const th = {
  ...
  dashboard: {
    ...
    turns: 'ครั้ง',
    firstResponse: 'ตอบครั้งแรก',
    handoffWait: 'รอเจ้าหน้าที่ (ค่ากลาง)',
    handoffs: 'ครั้งที่ส่งต่อ',
    noneAnswered: 'ยังไม่มีเจ้าหน้าที่รับเรื่องที่ส่งต่อ',
    stillUnanswered: 'ยังไม่มีคนตอบ {{count}} ครั้ง',
    peak: 'สูงสุด',
    tokens: 'โทเคน',
    notPriced: 'ยังไม่ได้ตั้งราคา',
    volumeSummary: 'บทสนทนา {{total}} รายการใน {{days}} วัน สูงสุด {{peak}} รายการต่อวัน',
  ...
  conversation: {
    ...
    handoffReasons: {
      ai_requested: 'AI ขอส่งต่อเอง',
      customer_requested: 'ลูกค้าขอคุยกับเจ้าหน้าที่',
      low_confidence: 'AI ไม่มั่นใจคำตอบ',
      negative_sentiment: 'ลูกค้าไม่พอใจ',
      keyword_rule: 'ตรงกับคำที่ตั้งให้ส่งต่อ',
      unsupported_media: 'ไฟล์ที่ AI อ่านไม่ได้',
      tool_error: 'เครื่องมือทำงานไม่สำเร็จ',
      model_error: 'เรียกโมเดลไม่สำเร็จ',
    },
  ...
  settings: {
    ...
    autoResolve: 'ปิดบทสนทนาอัตโนมัติ',
    autoResolveHint:
      'ปิดบทสนทนาที่ AI ดูแลอยู่ (รวมถึงโหมด AI ร่าง) เมื่อฝั่งเราตอบล่าสุดแล้วลูกค้าเงียบไป รวมถึงบทสนทนาที่เจ้าหน้าที่ส่งคืนให้ AI แล้ว ไม่ปิดบทสนทนาที่รอเจ้าหน้าที่หรือเจ้าหน้าที่ดูแลอยู่ ถ้าลูกค้าพิมพ์มาใหม่จะเปิดอีกครั้งเอง',
    autoResolveHours: 'ปิดเมื่อลูกค้าเงียบไป (ชั่วโมง)',
    autoResolveOff: 'เว้นว่างเพื่อปิดการทำงาน',
    autoResolveOffHint: 'เว้นว่างไว้ จะไม่ปิดบทสนทนาอัตโนมัติ',
    autoResolveInvalid: 'ใส่จำนวนชั่วโมงเต็มระหว่าง 1 ถึง 720 หรือเว้นว่างไว้ ค่านี้ยังไม่ได้บันทึก',
  ...
  common: {
    ...
    edit: 'แก้ไข',
    remove: 'นำออก',
    removeConfirm: 'กดอีกครั้งเพื่อลบ',
    cancel: 'ยกเลิก',
    close: 'ปิด',
    save: 'บันทึก',
    you: 'คุณ',
...
const en: typeof th = {
  ...
  dashboard: {
    ...
    handoffWait: 'Wait for a person (median)',
    handoffs: 'handoffs',
    noneAnswered: 'Nobody has picked up a handoff yet',
    stillUnanswered: '{{count}} still unanswered',
    peak: 'peak',
    tokens: 'tokens',
    notPriced: 'Not priced',
    volumeSummary: '{{total}} conversations over {{days}} days, peaking at {{peak}} in a day',
    cost: 'Estimated cost',
    seconds: 'seconds',
    minutes: 'minutes',
    hours: 'hours',
  ...
  conversation: {
    ...
    handoffReasons: {
      ai_requested: 'The AI asked for a person',
      customer_requested: 'The customer asked for a person',
      low_confidence: 'The AI was not sure',
      negative_sentiment: 'The customer was unhappy',
      keyword_rule: 'Matched a handoff keyword',
      unsupported_media: 'A file the AI cannot read',
  ...
  settings: {
    ...
    autoResolve: 'Closing quiet conversations',
    autoResolveHint:
      'Resolves a conversation the AI is answering once our side has spoken last and the customer has gone quiet, including one a colleague handed back to the AI. Never one that is waiting for a person or that a colleague owns. If the customer writes again it reopens.',
    autoResolveHours: 'Close after the customer is quiet for (hours)',
    autoResolveOff: 'Leave empty to switch off',
    autoResolveOffHint: 'Leave this empty and conversations are never closed automatically.',
    autoResolveInvalid:
      'Use a whole number of hours from 1 to 720, or leave it empty. This was not saved.',
